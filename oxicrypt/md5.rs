...
impl Md5
{
    ...
    #[inline(always)]
    unsafe fn compress(h: *mut u32, block: *const u8) { md5_generic_md5_compress(h, block); }
}
...
impl FinishInternal for Md5
{
    fn finish_internal(&mut self) -> &[u8]
    {
        ...
        self.block[Self::BLOCK_LEN - BIT_COUNT_LEN..]
            .copy_from_slice(&Counter::to_le_bytes(len as _));
