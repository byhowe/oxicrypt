...
typedef struct oxi_hmac_md5* oxi_hmac_md5_t;
typedef struct oxi_hmac_sha1* oxi_hmac_sha1_t;
typedef struct oxi_hmac_sha224* oxi_hmac_sha224_t;
typedef struct oxi_hmac_sha256* oxi_hmac_sha256_t;
typedef struct oxi_hmac_sha384* oxi_hmac_sha384_t;
typedef struct oxi_hmac_sha512* oxi_hmac_sha512_t;
typedef struct oxi_hmac_sha512_224* oxi_hmac_sha512_224_t;
typedef struct oxi_hmac_sha512_256* oxi_hmac_sha512_256_t;
