...
void oxi_hmac_sha1_finish_into(oxi_hmac_sha1_t* ctx, uint8_t* out, size_t outlen);
void oxi_hmac_sha224_finish_into(oxi_hmac_sha224_t* ctx, uint8_t* out, size_t outlen);
void oxi_hmac_sha256_finish_into(oxi_hmac_sha256_t* ctx, uint8_t* out, size_t outlen);
void oxi_hmac_sha384_finish_into(oxi_hmac_sha384_t* ctx, uint8_t* out, size_t outlen);
void oxi_hmac_sha512_finish_into(oxi_hmac_sha512_t* ctx, uint8_t* out, size_t outlen);
void oxi_hmac_sha512_224_finish_into(oxi_hmac_sha512_224_t* ctx, uint8_t* out, size_t outlen);
void oxi_hmac_sha512_256_finish_into(oxi_hmac_sha512_256_t* ctx, uint8_t* out, size_t outlen);

void oxi_hmac_sha1_finish_into_impl(oxi_hmac_sha1_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
void oxi_hmac_sha224_finish_into_impl(oxi_hmac_sha224_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
void oxi_hmac_sha256_finish_into_impl(oxi_hmac_sha256_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
void oxi_hmac_sha384_finish_into_impl(oxi_hmac_sha384_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
void oxi_hmac_sha512_finish_into_impl(oxi_hmac_sha512_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
void oxi_hmac_sha512_224_finish_into_impl(oxi_hmac_sha512_224_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
void oxi_hmac_sha512_256_finish_into_impl(oxi_hmac_sha512_256_t* ctx, oxi_implementation_t implementation, uint8_t* out, size_t outlen);
